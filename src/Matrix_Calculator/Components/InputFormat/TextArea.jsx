  ...
  // Event handler to update the state when the textbox value changes
    ...
    return (
        <div className="input">
            ...
            {props.modal?<Answer transpose={props.transpose} row={props.row} col={props.col} error={props.error} evl={props.evl} lu={props.lu} chp={props.chp} svd={props.svd} evt={props.evt}  operation={props.operation} closeModal={closeModal} answer={props.answer} input={inputValue}/>:null}
        </div>
    )
}
