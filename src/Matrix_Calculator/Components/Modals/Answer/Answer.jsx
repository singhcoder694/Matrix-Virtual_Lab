...
function evt_matrix(array,size){
    var boxes=[];
    for (let i = 0; i < size; i++) {
        boxes.push(<input className="box answer_box" key={i} value={array[i][0] + " + (" + array[i][1] + ")j"}></input>);
    }
    return boxes;
...
function Answer(props) {
    ...
    const gridStyle2 = {
        display: 'grid',
        gridTemplateColumns: `repeat(${perSquare(answer[0]?answer[0].length:1)?size:1}, fit-content(1000px))`, // Adjust the box width as needed
        gridGap: '2px', // Adjust the gap between boxes as needed
        placeItems: 'center center',
        margin: 'auto auto',
        padding:"5px 5px",
    ...
    const evtStyle = {
        display: 'grid',
        gridTemplateColumns: `repeat(${answer[0]?answer[0].length+1:null}, auto)`, // Adjust the box width as needed
  ...
  return (
    <>
        ...
        {
            !(props.evl) && !(props.lu) && !(props.chp) && !(props.svd) && !(props.evt) && valid_array(array) && <div className='modal_background' onClick={closeModal}>
                <div className="modal">
                {console.log("lksajdflk")}
                    ...
                    <div className='answer'>
                        ...
                        <div className='ques_matrix' style={answer[0]?gridStyle2:gridStyle}>
        ...
        {
            (props.evl && !props.lu && !props.svd) && (!props.chp)  && (!props.evt) && valid_array(array) && <div className='modal_background' onClick={closeModal}>
                        ...
                        <div style={{display:"flex", flexDirection:"column"}}>
                            {answer.map((answer,index)=>(
                                <div className='ques_matrix' style={evtStyle} key={index}>
                                    <p style={{color:"white", fontSize:"1.5rem", margin:"20px"}}>Value{index+1}</p>
                ...
                <div className="modal">
                    ...
                    <div className='answer'>
                        ...
                        <div className='equal_sign'>=</div>
                            {answer.map((answer,index)=>(
                                <div style={{display:"flex", flexDirection:"column"}}>
                                    <p style={{textAlign:"center", color:"white",fontSize:"1.5rem"}}>{LUD[index]}</p>
                                    <div className='ques_matrix' style={gridStyle}>
            ...
            (!props.evl && !props.lu && props.svd) && !(props.chp)  && (!props.evt) && valid_array(array) && <div className='modal_background' onClick={closeModal}>
                <div className="modal">
                    ...
                    <div className='answer'>
                        ...
                        <div className='equal_sign'>=</div>
                        <div style={{display:"flex", flexDirection:"column"}}>
                            <p style={{textAlign:"center", color:"white",fontSize:"1.5rem"}}>U</p>
                            <div className='ques_matrix' style={gridStyle}>
                                {Answer_Matrix(answer[0][0],Math.sqrt(answer[0][0].length))}
                            </div>
                        </div>
                        <div style={{display:"flex", flexDirection:"column"}}>
                            <p style={{textAlign:"center", color:"white",fontSize:"1.5rem"}}>S</p>
                            <div className='ques_matrix' style={gridStyle}>
                                {Answer_Matrix(answer[1],(answer[1].length))}
                            </div>
                        </div>
                        <div style={{display:"flex", flexDirection:"column"}}>
                            <p style={{textAlign:"center", color:"white",fontSize:"1.5rem"}}>V</p>
                            <div className='ques_matrix' style={gridStyle}>
                                {Answer_Matrix(answer[2][0],Math.sqrt(answer[2][0].length))}
                            </div>
                        </div>
                    </div>
                    <button onClick={closeModal}>OK</button>
        ...
        {
            ( !props.evl && !props.lu && !props.svd) && (props.chp)  && (!props.evt) && <div className='modal_background' onClick={closeModal}>
                <div className="modal">
                    <p className='head'>{props.operation}</p>
                    <div className='answer'>
                        <div className='ques_matrix' style={gridStyle}>
                        ...
                        <div className='equal_sign'>=</div>
                        <div className='ques_matrix' style={answer[0]?gridStyle2:gridStyle}>
                            <p style={{color:"white", fontSize:"1.5rem", textAlign:"center", lineHeight:"3rem"}}>{answer}</p>
                        </div>
                    </div>
                    <button onClick={closeModal}>OK</button>
                </div>
                ...
                <div className="modal evt_modal">
                    ...
                    <div className='evt_answer'>
                        ...
                        <div style={{display:"flex", flexDirection:"column"}}>
                            ...
                            {answer.map((answer,index)=>(
                                <div className='ques_matrix' style={evtStyle} key={index}>
                                    <p style={{color:"white", fontSize:"1.5rem", margin:"20px"}}>Vector{index+1}</p>
